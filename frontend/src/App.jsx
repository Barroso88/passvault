...
const THEMES = {
  ...
  ocean: { name: 'Deep Ocean', vars: { '--bg': '#082f49', '--surface': '#0c4a6e', '--surface-hover': '#075985', '--primary': '#38bdf8', '--primary-hover': '#0ea5e9', '--text': '#f0f9ff', '--text-muted': '#bae6fd', '--border': '#075985', '--danger': '#ef4444' } },
  lavender: { name: 'Soft Lavender', vars: { '--bg': '#faf5ff', '--surface': '#ffffff', '--surface-hover': '#f3e8ff', '--primary': '#a855f7', '--primary-hover': '#9333ea', '--text': '#4c1d95', '--text-muted': '#7e22ce', '--border': '#e9d5ff', '--danger': '#ef4444' } },
  coffee: { name: 'Warm Coffee', vars: { '--bg': '#272320', '--surface': '#3b322c', '--surface-hover': '#4f443c', '--primary': '#d4a373', '--primary-hover': '#e9b485', '--text': '#fefae0', '--text-muted': '#faedcd', '--border': '#4f443c', '--danger': '#e07a5f' } },
  hacker: { name: 'Terminal Green', vars: { '--bg': '#000000', '--surface': '#0a0a0a', '--surface-hover': '#111111', '--primary': '#00ff00', '--primary-hover': '#00cc00', '--text': '#00ff00', '--text-muted': '#008800', '--border': '#003300', '--danger': '#ff0000' } },
  solarized: { name: 'Solarized', vars: { '--bg': '#fdf6e3', '--surface': '#eee8d5', '--surface-hover': '#e4ddcc', '--primary': '#268bd2', '--primary-hover': '#2aa198', '--text': '#657b83', '--text-muted': '#93a1a1', '--border': '#ccc2a3', '--danger': '#dc322f' } },
  dracula: { name: 'Dracula', vars: { '--bg': '#282a36', '--surface': '#44475a', '--surface-hover': '#6272a4', '--primary': '#bd93f9', '--primary-hover': '#ff79c6', '--text': '#f8f8f2', '--text-muted': '#bd93f9', '--border': '#6272a4', '--danger': '#ff5555' } },
  monokai: { name: 'Monokai', vars: { '--bg': '#272822', '--surface': '#3e3d32', '--surface-hover': '#49483e', '--primary': '#a6e22e', '--primary-hover': '#f92672', '--text': '#f8f8f2', '--text-muted': '#75715e', '--border': '#49483e', '--danger': '#f92672' } },
  nord: { name: 'Nord Frost', vars: { '--bg': '#2e3440', '--surface': '#3b4252', '--surface-hover': '#434c5e', '--primary': '#88c0d0', '--primary-hover': '#81a1c1', '--text': '#eceff4', '--text-muted': '#d8dee9', '--border': '#4c566a', '--danger': '#bf616a' } },
  cherry: { name: 'Cherry Blossom', vars: { '--bg': '#fff0f5', '--surface': '#ffe4e1', '--surface-hover': '#ffb6c1', '--primary': '#ff69b4', '--primary-hover': '#ff1493', '--text': '#8b0a50', '--text-muted': '#db7093', '--border': '#ffb6c1', '--danger': '#dc143c' } },
  gold: { name: 'Luxury Gold', vars: { '--bg': '#000000', '--surface': '#111111', '--surface-hover': '#222222', '--primary': '#d4af37', '--primary-hover': '#b8860b', '--text': '#ffffff', '--text-muted': '#c0c0c0', '--border': '#333333', '--danger': '#ff0000' } },
};
                      ...
                      <div className="flex min-w-0 flex-1 items-center gap-1.5 sm:gap-3">
                        ...
                        <div className="min-w-0">
                          <div className="flex min-w-0 items-center gap-2">
                            <h3 className="truncate text-[18px] leading-[1.2] font-semibold tracking-wide text-white sm:text-[15px]">{cat.name}</h3>
